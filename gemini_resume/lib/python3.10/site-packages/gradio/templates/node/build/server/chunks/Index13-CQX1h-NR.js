...
import { B as Block, S as Static, e as BlockLabel, W as Code$2, g as Empty, i as IconButton, K as Copy$1, D as Download$1, h as IconButtonWrapper } from './2-BhxJEyuP.js';
...
const lang_map = {
  python: () => import('./index27-BBQQEN6g.js').then((m) => m.python()),
  ...
  markdown: async () => {
    const [md, frontmatter] = await Promise.all([
      import('./index28-CKnWN3Zc.js'),
      import('./frontmatter-NDadOauS.js')
    ]);
    return md.markdown({ extensions: [frontmatter.frontmatter] });
  },
  json: () => import('./index32-B8dQD56B.js').then((m) => m.json()),
  html: () => import('./index29-XL-JWm8Y.js').then((m) => m.html()),
  css: () => import('./index30-Ba35vmJa.js').then((m) => m.css()),
  javascript: () => import('./index31-BnE7zkKk.js').then((m) => m.javascript()),
  jinja2: () => import('./jinja2-BxhAu_54.js').then(
    (m) => StreamLanguage.define(m.jinja2)
  ),
  typescript: () => import('./index31-BnE7zkKk.js').then(
...
//# sourceMappingURL=Index13-CQX1h-NR.js.map
