...
import { B as Block, S as Static, e as BlockLabel, C as Chat, h as IconButtonWrapper, i as IconButton, G as Community, H as Trash, J as MarkdownCode, K as Copy, N as ScrollDownArrow, R as Retry, v as Undo } from './2-BhxJEyuP.js';
...
const ButtonPanel = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${show_copy || show_retry || show_undo || likeable ? `<div class="${"message-buttons-" + escape(position, true) + " " + escape(layout, true) + " message-buttons " + escape(avatar !== null && "with-avatar", true) + " svelte-1ibfe7l"}">${validate_component(IconButtonWrapper, "IconButtonWrapper").$$render($$result, { top_panel: false }, {}, {
    default: () => {
...
const Message = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${[
    "message-row " + escape(layout, true) + " " + escape(role, true) + "-row svelte-pbswnk",
    (avatar_img !== null ? "with_avatar" : "") + " " + (opposite_avatar_img !== null ? "with_opposite_avatar" : "")
  ].join(" ").trim()}">${avatar_img !== null ? `<div class="avatar-container svelte-pbswnk">${validate_component(Image$1, "Image").$$render(
    $$result,
    {
      class: "avatar-image",
      src: avatar_img?.url,
    ...
    return `<div class="${[
    ...
    })}>${message.type === "text" ? `<div class="message-content svelte-pbswnk">${message.metadata.title ? `${validate_component(MessageBox, "MessageBox").$$render(
      $$result,
      {
        title: message.metadata.title,
        expanded: is_last_bot_message([message], value)
      ...
      {},
      {}
    )}` : `${message.type === "component" && message.content.component === "file" ? `<a data-testid="chatbot-file" class="file-pil svelte-pbswnk"${add_attribute("href", message.content.value.url, 0)} target="_blank"${add_attribute(
      "download",
...
//# sourceMappingURL=Index56-DGckTNbo.js.map
